...
class NewModel(LabelStudioMLBase):
    ...
    def setup(self):
        ...
        self.model = YOLO('/home/liujiawei/ultralytics-main/runs/pose/train28/weights/best.pt', task='predict')
        self.rectanglelabels = ['装甲板', '左上', '左中', '左下', '右上', '右中', '右下']
    def predict(self, tasks: List[Dict], context: Optional[Dict] = None, **kwargs) -> ModelResponse:
        ...
        """
        pprint(tasks[0])
        image_path = '/'+tasks[0]['data']['image'][21:]
        ...
        predict_results = list(zip(clss, conf, boxes))
